import requests
import json
from apikey_and_range import my_api_key
from apikey_and_range import range
import os

api_url = f"https://sheets.googleapis.com/v4/spreadsheets/1ECmr-99sZb5I1yY3Lcyy8kxDPmqlKGU6s-3S53OIMwY/values/test!{range}?majorDimension=COLUMNS&key="
api_key = my_api_key
# f-stringでつなげる
